...
<head>
    ...
    <link rel="stylesheet" href="../css/confirm-alert.css">
...
<div id="page-content-wrapper">
    ...
    <!--FOOTER-->
<footer class="page-footer blue-grey darken-1 mt-5">
    <div class="container">
        <div class="row">
          <div class="col-lg-6 mt-4">
      ...
      <div class="footer-copyright">
          <div class="container">
              <div class="row mt-4">
                  ...
                  <div class="col-lg-6">
                    <label class="right">Realizado por: <b class="text-white">Sergio Alberto Márquez Moreno</b></label>
                  </div>
              </div>
          </div>
      </div>
...
<script type="text/javascript" src="../js/confirm-alert.js"></script>
